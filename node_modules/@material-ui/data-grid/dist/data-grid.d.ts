import { HTMLAttributes, RefObject, ForwardRefExoticComponent, RefAttributes, ComponentType, ReactElement, NamedExoticComponent, MouseEvent as MouseEvent$1, FC, ElementType, ReactNode, PropsWithChildren, Dispatch, MutableRefObject, Context, Reducer, MemoExoticComponent } from 'react';
...
interface GridColumnHeaderMenuItemsProps {
    hideMenu: () => void;
    currentColumn: ColDef;
}
declare function GridColumnHeaderMenuItems(props: GridColumnHeaderMenuItemsProps): JSX.Element;
...
declare function DensitySelector(): JSX.Element;
...
declare type ColumnMenuProps = BaseComponentProps & GridColumnHeaderMenuItemsProps;
/**
