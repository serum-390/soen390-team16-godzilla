...
function AccountingHelp() {
  return (
    <div>
      <h1>Accounting</h1>
      <h4>Any transactions (sales and purchase orders) processed via the GODZILLA enterprise resource planning system will be automatically displayed in the Accounting section, simmilar to the entry below</h4>
