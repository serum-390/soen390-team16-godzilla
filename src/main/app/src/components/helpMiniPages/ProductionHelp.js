...
function ProductionHelp() {
  return (
    <div>
      <h1>Production</h1>
      <h4>The Production Page displays a list of all items in the production line until the items are completed. This list consists of :</h4>
      <ul>
        <li>Raw materials</li>
        <li>Products under assembly</li>
      </ul>
      <h4>All completed items will be removed from the production line and displayed in the inventory page</h4>
