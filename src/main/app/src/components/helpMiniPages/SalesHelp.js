...
function SalesHelp() {
  return (
    <div>
      ...
      <h4>Customers and sales orders can be added to, edited and deleted from their respective tables. </h4>
      <h4>To add a customers, select "Add new customers ", while to add a purchase, select "Add new sales</h4>
      <h4>To edit or delete a customers  record or sales order , navigate to the desired record in it's table , and select the "Edit" or "Delete" button respectively</h4>
      ...
      <h4>Both the customer and sales order tables  can easily be expored as an external .csv file for usage.</h4>
