...
function AccountingHelp() {
  return (
    <div>
      <h1>Accounting</h1>
      <h4>
        Any transactions (sales and purchase orders) processed via the GODZILLA
        enterprise resource planning system will be automatically displayed in
        the Accounting section, simmilar to the entry below
      </h4>
      ...
      <h4>
        Display of transactions can be customized in order to hide/show
        additional collumns
      </h4>
      <h2>Exporting as CSV</h2>
      <h4>
        Transactions can easily be expored as an external .csv file for usage.
      </h4>
      <img
        src={exportImage}
        alt="img"
