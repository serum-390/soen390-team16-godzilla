...
function PurchasingHelp() {
  return (
    <div>
      ...
      <h4>
        Vendors and purchase orders can be added to, edited and deleted from
        their respective tables.{" "}
      </h4>
      <h4>
        To add a vendor, select "Add new vendor", while to add a purchase,
        select "Add new purchase{" "}
      </h4>
      <h4>
        To edit or delete a vendor record or purchase order , navigate to the
      ...
      <h4>
        Both the vendors and purchase order tables can easily be expored as an
