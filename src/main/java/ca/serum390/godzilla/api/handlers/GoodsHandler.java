...
public class GoodsHandler {
    ...
    /**
     * ??? NOTE: This {@link GoodsRepository} parameter is injected into the class
    ...
    public Mono<ServerResponse> all(ServerRequest request) {
        return ok().body(goods.findAll(), Good.class);
    }

    public Mono<ServerResponse> create(ServerRequest req) {
        return req.bodyToMono(Good.class).flatMap(goods::save)
